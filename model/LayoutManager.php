...
class LayoutManager {
    ...
    static function drawFooter() {
        ...
        $sFooterTemplate .= "<text x=\"50\" y=\"80\" fill=\"black\" font-size=\"26\" font-weight=\"700\" font-family=\"".FONT_FAMILY."\" text-anchor=\"start\"><tspan>6:30 - 22:30 - алғашқы жəне соңғы автобустың өту уақыты</tspan><tspan x=\"205\" dy=\"1.2em\">время первого и последнего автобуса на маршруте</tspan><tspan x=\"100\" dy=\"1.2em\">*</tspan><tspan x=\"195\">- демалыс күндерінің кестесі/расписание в выходные дни</tspan></text>";
