...
class LegendManager
{
    ...
    static function drawBusNumber($sBusNumber, $sFontColor)
    {
        ...
        $iOffsetY = 100;
        // <!-- Bus number -->
        $sNumberTemplate = "<text x=\"{$iOffsetX}\" y=\"{$iOffsetY}\" fill=\"{$sFontColor}\" font-size=\"72\" font-family=\"".FONT_FAMILY."\" font-weight=\"700\" text-anchor=\"middle\">{$sBusNumber}</text>\n";
    ...
    static function drawStopCaptions($sStartCaption, $sEndCaption, $sFontColor)
    {
        ...
        $iOffsetY = 30;
        // <!-- Bus stop caption -->
        $sCaptionTemplate = "<text x=\"{$iOffsetX}\" y=\"{$iOffsetY}\" fill=\"{$sFontColor}\" font-size=\"24\" font-family=\"".FONT_FAMILY."\" font-weight=\"700\">\n";
    ...
    static function drawWorkingHours($sFwrdTime, $sBwrdTime, $sFontColor)
    {
        ...
        // <!-- Working hours -->
        $sWorkingHoursTemplate = "<text x=\"{$iOffsetX}\" y=\"{$iOffsetY}\" fill=\"{$sFontColor}\" font-size=\"24\" font-family=\"".FONT_FAMILY."\" font-weight=\"700\" text-anchor=\"middle\">\n";
        // <!-- (forward) -->
    ...
    static function drawInterval($sTimeInterval, $sFontColor)
    {
        ...
        $iOffsetY = 130;
        $sIntervalTemplate = "<text x=\"{$iOffsetX}\" y=\"{$iOffsetY}\" fill=\"{$sFontColor}\" font-size=\"48\" font-family=\"".FONT_FAMILY."\" font-weight=\"700\" text-anchor=\"middle\">{$sTimeInterval}</text>";
